...
const cgList = computed(() => [
  ...
  { id: 'cg_02', title: '秘密会谈', description: '地下党的会面', image: '/images/cg/cg_02.jpg', unlocked: gameStore.hasFlag('ch1_truth_to_fangmin') },
  { id: 'cg_03', title: '牺牲', description: '为了信仰', image: '/images/cg/cg_03.jpg', unlocked: gameStore.deathCount > 0 }
  // 更多CG...
]);
...
const endingsList = computed(() => {
  // 从成就系统加载结局数据
  return [
    { id: 'end_01', type: 'bad', title: '出师未捷', description: '第一次任务就失败了', unlocked: gameStore.deathCount > 0, unlockedAt: '2024-01-01', unlockHint: '在第一章中死亡' },
    { id: 'end_02', type: 'good', title: '新的起点', description: '成功完成第一章', unlocked: gameStore.hasFlag('ch1_complete'), unlockedAt: '2024-01-02', unlockHint: '完成第一章' }
  ];
});
...
.ending-card.good { border-color: #27ae60; }
.ending-card.bad { border-color: #e74c3c; }
.ending-card.hidden { border-color: #9b59b6; }
.ending-card.true { border-color: #f1c40f; }
.ending-card.locked {
  opacity: 0.5;
