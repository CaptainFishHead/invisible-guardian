...
const sceneTransition = {
  ...
  cinematicCut: (oldEl: HTMLElement, newEl: HTMLElement) => {
    ...
    tl.to(oldEl, { filter: "grayscale(100%)", duration: 0.3 })
      .fromTo(newEl,
...
export const useGameStore = defineStore('game', () => {
  ...
  const canSeeHiddenInfo = computed(() =>
    ...
    gameState.value.attributes.情报值 >= 70
  );
...
<template>
  <div class="video-player" :class="{ 'loading': isLoading }">
    ...
    <!-- 点击继续提示 -->
    <div v-if="showClickHint" class="click-hint" @click="onClick">
      点击继续
    </div>
  </div>
</template>
      ...
      <div class="choices-container">
        ...
        <div class="choices-list">
          ...
          >
            ...
            <!-- 隐藏提示 -->
            <span v-if="choice.showHiddenInfo" class="hidden-tip">
              💡 {{ choice.hiddenInfo }}
            </span>

            <!-- 倒计时条 -->
            <div v-if="hasTimer && !choice.disabled" class="countdown-bar"
...
function startTimer() {
  ...
  timerInterval = window.setInterval(() => {
    ...
    if (timeLeft.value <= 0) {
      stopTimer();
      // 自动选择第一个可用选项，或触发超时
      const available = props.choices.find((c, i) =>
        !processedChoices.value[i].disabled
      );
                ...
                <div class="events">
                  ...
                  >
                    ...
                    <div class="event-card">
                      ...
                      <div v-if="event.choiceText" class="event-choice">
                        选择: {{ event.choiceText }}
                      </div>
...
function canJumpTo(event: any): boolean {
  ...
  const currentIndex = gameStore.history.findIndex(
    h => h.nodeId === gameStore.gameState.currentNode
  );
...
function canContinue(chapterId: string): boolean {
  return gameStore.currentChapter === chapterId &&
         gameStore.gameState.currentNode !== '';
}
